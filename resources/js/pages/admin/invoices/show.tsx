...
export default function AdminInvoicesShow({ invoice }: Props) {
                ...
                <div className="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent className="flex flex-wrap gap-2">
                            <Link href={`/admin/students/${invoice.enrollment.student.id}`}>
                                <Button variant="outline" size="sm">
                                    <User className="mr-2 h-4 w-4" />
                                    View Student
                                </Button>
                            </Link>
                            <Link href={`/admin/enrollments/${invoice.enrollment.id}`}>
                                <Button variant="outline" size="sm">
                                    <FileText className="mr-2 h-4 w-4" />
                                    View Enrollment
                                </Button>
                            </Link>
                            <a href={`/admin/invoices/${invoice.id}/download`} target="_blank">
                                <Button variant="outline" size="sm">
                                    <FileText className="mr-2 h-4 w-4" />
                                    Download Invoice
                                </Button>
                            ...
                            {remainingBalance > 0 && (
                                <Link href={`/admin/payments/create?invoice_id=${invoice.id}`}>

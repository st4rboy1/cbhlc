        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className="flex gap-2">
                    <Button size="sm" variant="outline" onClick={() => router.visit(`/admin/settings/${row.original.id}`)}>
                        <Eye className="mr-1 h-3 w-3" />
                        View
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => router.visit(`/admin/settings/${row.original.id}/edit`)}>
                        Edit
                    </Button>
                </div>
            ),

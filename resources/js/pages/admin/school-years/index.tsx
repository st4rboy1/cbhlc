        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className="flex gap-2">
                    <Button size="sm" variant="outline" onClick={() => router.visit(`/admin/school-years/${row.original.id}`)}>
                        View
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => router.visit(`/admin/school-years/${row.original.id}/edit`)}>
                        Edit
                    </Button>
                </div>
            ),
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-4 py-6">
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <Link href="/admin/school-years/create">
                        <Button>

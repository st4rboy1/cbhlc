...
export default function StudentEdit({ student, guardians, gradelevels }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: `Edit ${student.first_name} ${student.last_name}`, href: `/admin/students/${student.id}/edit` },
    ];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('admin.students.update', { student: student.id }));
    };
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <Select
                                    value={data.guardian_ids[0]?.toString() || ''}
                                    onValueChange={(value) => setData('guardian_ids', [parseInt(value)])}
                                >

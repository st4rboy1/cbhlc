...
export default function Tuition() {
    ...
    const [billingOpen, setBillingOpen] = useState(true); // Default open since we're on a billing page
                            ...
                            <li>
                                <div>
                                    <button 
                                        ...
                                        className="flex items-center justify-between w-full p-2 rounded bg-slate-600 text-white transition-all duration-200"
                                    >
                                        <div className="flex items-center space-x-3">
                                    ...
                                    {billingOpen && (
                                        <div className="ml-8 mt-2 space-y-1 animate-in slide-in-from-top-2 duration-200">
                                            <Link href="/tuition" className="block p-2 text-sm bg-slate-600 rounded transition-all duration-200">
                                                Tuition
                                            </Link>
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <header className="bg-white p-6 border-b">
                        <div className="flex justify-between items-center">
                            <h1 className="text-2xl font-bold text-gray-800">TUITION</h1>
                    ...
                    <div className="flex-1 p-6">
                        <div className="bg-white rounded-lg p-6 shadow-sm">
                            <h2 className="text-xl font-semibold text-gray-800 mb-4">Tuition Management</h2>
                            <p className="text-gray-600">Tuition content will be displayed here.</p>
                        </div>
                    </div>
                </div>
            </div>

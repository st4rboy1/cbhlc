                ...
                <div className="space-y-4 rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">{enrollment.student.student_id}</p>
                        </div>
                        <div>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <Badge variant={getPaymentStatusVariant(enrollment.payment_status)}>{formatStatusName(enrollment.payment_status)}</Badge>
                        </div>
                    </div>

                                ...
                                <div>
                                    ...
                                    {billingOpen && (
                                        <div className="ml-8 mt-2 space-y-1 animate-in slide-in-from-top-2 duration-200">
                                            ...
                                            <Link href="/invoice" className="block p-2 text-sm bg-slate-600 rounded transition-all duration-200">
                                                Invoice
                                            </Link>
                                        </div>
                                    )}
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex-1 p-6">
                        <div className="bg-white rounded-lg p-6 shadow-sm">
                            <h2 className="text-xl font-semibold text-gray-800 mb-4">Invoice Management</h2>
                            <p className="text-gray-600">Invoice content will be displayed here.</p>
                        </div>
                    </div>
                </div>
            </div>
